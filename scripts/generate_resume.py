...
COPY = {
    "en": {
        ...
        "background": "Independent composer and multi-instrumentalist. Experienced in translating ambiguous creative requirements into structured, testable production workflows and clear deliverables.",
    ...
    "it": {
        ...
        "background": "Compositore e polistrumentista indipendente. Esperienza nel trasformare richieste creative ambigue in workflow produttivi strutturati, verificabili e orientati a risultati chiari.",
